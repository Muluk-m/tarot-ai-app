...
// Temporarily disabled while debugging - will be re-enabled later
...
export default function RootLayout() {
  // Note: isLoading and error are intentionally unused while loading screen is disabled for debugging
...
// Styles temporarily disabled with LoadingScreen/ErrorScreen
