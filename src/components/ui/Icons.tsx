...
// 卡片堆叠图标 - 闪卡/卡牌
export const CardsIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Rect x="3" y="4" width="12" height="16" rx="2" stroke={color} strokeWidth={strokeWidth} />
    <Rect x="9" y="4" width="12" height="16" rx="2" stroke={color} strokeWidth={strokeWidth} fill="none" />
    <Circle cx="15" cy="12" r="3" stroke={color} strokeWidth={strokeWidth * 0.75} fill="none" />
  </Svg>
);

// 奖杯图标 - 成就/测验
export const TrophyIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M6 9H4.5A2.5 2.5 0 012 6.5v0A2.5 2.5 0 014.5 4H6" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Path d="M18 9h1.5A2.5 2.5 0 0022 6.5v0A2.5 2.5 0 0019.5 4H18" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Path d="M6 4h12v8a6 6 0 01-6 6v0a6 6 0 01-6-6V4z" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M12 18v3M8 21h8" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
  </Svg>
);

// 时钟图标 - 历史
export const ClockIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 星星闪烁图标 - 神秘/特殊
export const SparkleIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M12 2L13.5 8.5L20 10L13.5 11.5L12 18L10.5 11.5L4 10L10.5 8.5L12 2Z" stroke={color} strokeWidth={strokeWidth} strokeLinejoin="round" />
...
// 右箭头图标
export const ChevronRightIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 左箭头图标
export const ChevronLeftIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 上箭头图标
export const ChevronUpIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 下箭头图标
export const ChevronDownIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 播放图标
export const PlayIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 暂停图标
export const PauseIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 洗牌图标
export const ShuffleIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 刷新图标
export const RefreshIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M1 4v6h6M23 20v-6h-6" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M20.49 9A9 9 0 005.64 5.64L1 10m22 4l-4.64 4.36A9 9 0 013.51 15" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);

// 设置图标
export const SettingsIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 用户图标
export const UserIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 星星图标 - 收藏
export const StarIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 心形图标 - 喜欢
export const HeartIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 分享图标
export const ShareIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 信息图标
export const InfoIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Circle cx="12" cy="12" r="10" stroke={color} strokeWidth={strokeWidth} />
...
// 问号图标
export const HelpIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Circle cx="12" cy="12" r="10" stroke={color} strokeWidth={strokeWidth} />
...
// 锁图标 - 锁定
export const LockIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 解锁图标
export const UnlockIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Rect x="3" y="11" width="18" height="11" rx="2" ry="2" stroke={color} strokeWidth={strokeWidth} />
    <Path d="M7 11V7a5 5 0 019.9-1" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);

// 日历图标
export const CalendarIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 奖章图标 - 成就
export const AwardIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Circle cx="12" cy="8" r="6" stroke={color} strokeWidth={strokeWidth} />
    <Path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);
...
// 目标图标
export const TargetIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Circle cx="12" cy="12" r="10" stroke={color} strokeWidth={strokeWidth} />
...
// 趋势上升图标
export const TrendingUpIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 图层图标
export const LayersIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 网格图标 - 百科
export const GridIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 列表图标
export const ListIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 笔记本图标 - 日记
export const BookmarkIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 编辑图标
export const EditIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 垃圾桶图标
export const TrashIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 月亮图标 - 神秘
export const MoonIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 主页图标
export const HomeIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 加号图标
export const PlusIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// 减号图标
export const MinusIcon: React.FC<IconProps> = ({ size = 24, color = '#D4AF37', strokeWidth = 2 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Line x1="5" y1="12" x2="19" y2="12" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
  </Svg>
);
