  ...
  const renderSymbol = () => {
    ...
    switch (suit) {
      case 'wands':
        ...
        return (
          <G>
            <Path d="M12 2 L12 22" stroke={fillColor} strokeWidth="2" strokeLinecap="round" />
      ...
      case 'cups':
        ...
        return (
          <G>
            <Path d="M6 8 Q6 12 12 14 Q18 12 18 8 L18 6 L6 6 Z" fill={fillColor} />
      ...
      case 'swords':
        ...
        return (
          <G>
            <Path d="M12 2 L12 16" stroke={fillColor} strokeWidth="2" strokeLinecap="round" />
