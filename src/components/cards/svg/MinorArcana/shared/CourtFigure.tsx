...
const PageFigure: React.FC<{ color: string }> = ({ color }) => {
  ...
  return (
    <G transform="translate(60, 75)">
      ...
      {/* 服装轮廓 */}
      <Path d="M-15 20 Q-18 40, -12 60 L12 60 Q18 40, 15 20" stroke={stroke.white} strokeWidth={1.5} fill="none" />
...
const KnightFigure: React.FC<{ color: string }> = ({ color }) => {
  ...
  return (
    <G transform="translate(60, 55)">
      ...
      {/* 头盔 */}
      <Path d="M-13 -5 Q-10 -15, -5 -12 Q0 -15, 3 -5" stroke={stroke.silver} strokeWidth={1.5} fill="none" />
      {/* 头盔羽毛 */}
      ...
      {/* 盔甲 */}
      <Rect x="-15" y="12" width="20" height="18" fill="none" stroke={stroke.silver} strokeWidth={1.5} rx={2} />
      ...
      <G transform="translate(5, 50)">
        {/* 马头 */}
        <Path d="M-30 -15 Q-35 -25, -25 -28 Q-15 -25, -20 -15" stroke={stroke.white} strokeWidth={1.5} fill="none" />
        {/* 马身 */}
        <Path d="M-20 -12 Q0 -18, 20 -12 Q30 -5, 25 10 L-25 10 Q-30 -5, -20 -12" stroke={stroke.white} strokeWidth={1.5} fill="none" />
        {/* 马腿 */}
...
const QueenFigure: React.FC<{ color: string }> = ({ color }) => {
  ...
  return (
    <G transform="translate(60, 60)">
      ...
      <Circle cx="0" cy="0" r="10" fill="none" stroke={stroke.white} strokeWidth={2} />
      {/* 王冠 */}
      <Path d="M-10 -8 L-8 -18 L-4 -12 L0 -20 L4 -12 L8 -18 L10 -8" stroke={gold} strokeWidth={1.5} fill="none" />
      ...
      {/* 长袍 */}
      <Path d="M-20 25 Q-25 50, -20 80 L20 80 Q25 50, 20 25" stroke={stroke.white} strokeWidth={1.5} fill="none" />
      {/* 袍子装饰 */}
      ...
      {/* 宝座（简化） */}
      <Rect x="-25" y="75" width="50" height="10" fill="none" stroke={gold} strokeWidth={1} rx={2} />
    </G>
  );
};
...
const KingFigure: React.FC<{ color: string }> = ({ color }) => {
  ...
  return (
    <G transform="translate(60, 55)">
      ...
      <Circle cx="0" cy="0" r="10" fill="none" stroke={stroke.white} strokeWidth={2} />
      {/* 王冠（更大更庄严） */}
      <Path d="M-12 -8 L-10 -22 L-5 -14 L0 -24 L5 -14 L10 -22 L12 -8" stroke={gold} strokeWidth={2} fill="none" />
      {/* 王冠顶部宝石 */}
      ...
      {/* 盔甲/长袍 */}
      <Rect x="-15" y="15" width="30" height="30" fill="none" stroke={stroke.white} strokeWidth={1.5} rx={3} />
      {/* 披风 */}
      ...
      {/* 袍子下摆 */}
      <Path d="M-20 45 Q-22 65, -18 85 L18 85 Q22 65, 20 45" stroke={stroke.white} strokeWidth={1.5} fill="none" />
      ...
      {/* 宝座 */}
      <Rect x="-28" y="80" width="56" height="12" fill="none" stroke={gold} strokeWidth={1.5} rx={2} />
      {/* 宝座扶手 */}
