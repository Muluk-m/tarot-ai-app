...
export const TheDevil: React.FC<CardSVGProps> = ({
  ...
  return (
    <Svg width={width} height={height} viewBox={SVG_CONFIG.viewBox}>
      ...
      <Rect x="0" y="0" width="120" height="180" rx={SVG_CONFIG.borderRadius} fill="url(#devil-bg)" />
      ...
      <G transform="translate(60, 45)">
        ...
        <G transform="translate(0, -5)">
          <Path d="M0 3 L2 -1 L5 -1 L3 2 L4 6 L0 4 L-4 6 L-3 2 L-5 -1 L-2 -1 Z"
                stroke={gold} strokeWidth={0.5} fill="none" opacity={0.7} />
        </G>

        {/* 蝙蝠翅膀 */}
        <G opacity={0.8}>
          {/* 左翼 */}
          <Path d="M-12 5 Q-35 -5, -40 25 Q-30 15, -25 30 Q-20 15, -12 15" stroke={stroke.silver} strokeWidth={1.5} fill="none" />
          {/* 右翼 */}
          <Path d="M12 5 Q35 -5, 40 25 Q30 15, 25 30 Q20 15, 12 15" stroke={stroke.silver} strokeWidth={1.5} fill="none" />
        </G>
        ...
        <G transform="translate(18, 10)">
          ...
          {/* 火焰 */}
          <Path d="M-3 -5 Q0 -15, 3 -5" stroke={CARD_COLORS.elements.fire} strokeWidth={1.5} fill="none" />
        </G>

        {/* 座位/立方体 */}
        <G transform="translate(0, 45)">
          <Rect x="-20" y="0" width="40" height="25" fill="none" stroke={stroke.silver} strokeWidth={1.5} rx={2} />
          {/* 铁环 */}
      ...
      <G transform="translate(30, 125)">
        ...
        {/* 锁链 */}
        <Path d="M0 -2 Q10 -5, 15 5" stroke={stroke.silver} strokeWidth={1} fill="none" strokeDasharray="2,2" />
      </G>
      ...
      <G transform="translate(90, 125)">
        ...
        <Line x1="0" y1="5" x2="0" y2="18" stroke={stroke.white} strokeWidth={1.5} />
        {/* 尾巴（火焰） */}
        <Path d="M0 18 Q5 22, 3 28" stroke={CARD_COLORS.elements.fire} strokeWidth={1} fill="none" />
        {/* 锁链 */}
        <Path d="M0 -2 Q-10 -5, -15 5" stroke={stroke.silver} strokeWidth={1} fill="none" strokeDasharray="2,2" />
      </G>

      {showNumber && (
        <G>
          <Circle cx="60" cy="160" r="10" fill={gold} opacity={0.15} />
          <SvgText x="60" y="165" textAnchor="middle" fontSize="10" fontWeight="700" fill={gold}>XV</SvgText>
        </G>
      )}
    </Svg>
  );
