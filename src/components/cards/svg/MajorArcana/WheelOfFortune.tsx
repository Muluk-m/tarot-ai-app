  ...
  return (
    <Svg width={width} height={height} viewBox={SVG_CONFIG.viewBox}>
      ...
      <G transform="translate(60, 80)">
        ...
        <SvgText x="36" y="3" textAnchor="middle" fontSize="8" fontWeight="600" fill={stroke.white}>
          A
        </SvgText>
        <SvgText x="0" y="40" textAnchor="middle" fontSize="8" fontWeight="600" fill={stroke.white}>
          R
        </SvgText>
        <SvgText
          x="-36"
      ...
      <G transform="translate(15, 80)">
        <Path
          d="M0 -25 Q-5 -15, 0 -5 Q5 5, 0 15 Q-5 25, 0 30"
