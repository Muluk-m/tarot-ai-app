...
export const Justice: React.FC<CardSVGProps> = ({
  ...
  return (
    <Svg width={width} height={height} viewBox={SVG_CONFIG.viewBox}>
      ...
      <Rect x="0" y="0" width="120" height="180" rx={SVG_CONFIG.borderRadius} fill="url(#justice-bg)" />
      <Rect x="3" y="3" width="114" height="174" rx={SVG_CONFIG.borderRadius - 1} fill="none" stroke={gold} strokeWidth={1} opacity={0.5} />

      {/* 两根柱子 */}
      <Rect x="15" y="20" width="8" height="120" fill="none" stroke={stroke.silver} strokeWidth={1} rx={2} />
      <Rect x="97" y="20" width="8" height="120" fill="none" stroke={stroke.silver} strokeWidth={1} rx={2} />
      ...
      <G transform="translate(60, 50)">
        ...
        {/* 王冠 */}
        <Path d="M-8 -8 L-6 -15 L-3 -10 L0 -16 L3 -10 L6 -15 L8 -8" stroke={gold} strokeWidth={1.5} fill="none" />
        ...
        {/* 长袍 */}
        <Path d="M-15 35 Q-18 55, -15 80 L15 80 Q18 55, 15 35" stroke={stroke.white} strokeWidth={1.5} fill="none" />
        {/* 披风细节 */}
      ...
      {/* 宝座 */}
      <Rect x="40" y="130" width="40" height="10" fill="none" stroke={gold} strokeWidth={1} rx={2} />

      {showNumber && (
        <G>
          <Circle cx="60" cy="160" r="10" fill={gold} opacity={0.15} />
          <SvgText x="60" y="165" textAnchor="middle" fontSize="12" fontWeight="700" fill={gold}>XI</SvgText>
        </G>
      )}
    </Svg>
  );
