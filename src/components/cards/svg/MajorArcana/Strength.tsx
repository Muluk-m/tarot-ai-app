  ...
  return (
    <Svg width={width} height={height} viewBox={SVG_CONFIG.viewBox}>
      ...
      <G transform="translate(60, 25)">
        <Path
          d="M-10 0 Q-10 -8, 0 0 Q10 8, 10 0 Q10 -8, 0 0 Q-10 8, -10 0"
          stroke={gold}
          strokeWidth={1.5}
          fill="none"
        />
      ...
      <G transform="translate(55, 55)">
        ...
        {/* 花环头饰 */}
        <Path
          d="M-8 -3 Q-10 -8, -5 -10 Q0 -12, 5 -10 Q10 -8, 8 -3"
          stroke={gold}
          strokeWidth={1}
          fill="none"
        />
        ...
        {/* 长裙 */}
        <Path
          d="M-12 35 Q-15 55, -10 75 L10 75 Q15 55, 12 35"
          stroke={stroke.white}
          strokeWidth={1}
          fill="none"
        />
      ...
      <G transform="translate(75, 85)">
        ...
        <Path
          d="M-10 -10 Q-8 -18, 0 -15 Q8 -18, 10 -10"
          stroke={gold}
          strokeWidth={1}
          fill="none"
        />
        ...
        {/* 身体 */}
        <Path
          d="M-10 12 Q-15 25, -8 40 L8 40 Q15 25, 10 12"
          stroke={gold}
          strokeWidth={1}
          fill="none"
        />
